...
def _write_minimal_main_dataset(tmp_dir):
    ...
    med_fields = ["patient_id", "condition", "previous_drug", "previous_class", "previous_dose_mg",
                  "previous_dose_unit", "previous_formulation", "previous_manufacturer", "previous_route",
                  "previous_start_date", "previous_prescriber", "current_drug", "current_class",
                  "current_dose_mg", "current_dose_unit", "current_formulation", "current_manufacturer",
                  "current_route", "current_start_date", "current_prescriber", "concurrent_medications",
                  "polypharmacy_count"]
    with open(os.path.join(tmp_dir, "medications.csv"), "w", newline="") as f:
        ...
        w.writerow({
            ...
            "previous_dose_unit": "mg", "previous_formulation": "Standard", "previous_manufacturer": "Teva",
            "previous_route": "Oral", "previous_start_date": "2026-01-01", "previous_prescriber": "Dr Test",
            "current_drug": "Ramipril", "current_class": "ACE inhibitor", "current_dose_mg": 10,
            "current_dose_unit": "mg", "current_formulation": "Standard", "current_manufacturer": "Teva",
            "current_route": "Oral", "current_start_date": "2026-02-01", "current_prescriber": "Dr Test",
