          ...
          <table className="rx-table">
            ...
            <tbody>
              <tr>
                ...
                <td>{formatDose(current.dose_mg, current.dose_unit)}</td>
            ...
            <tbody>
              {[...prescriptions].reverse().map((rx) => (
                <tr key={rx.prescription_id} className={rx.is_current ? "row-current" : ""}>
                  <td>{rx.drug_name}</td>
                  <td>{rx.drug_class}</td>
                  <td>{formatDose(rx.dose_mg, rx.dose_unit)}</td>
        ...
        <section className="dispense-panel">
          {dispensed ? (
            <p className="dispense-confirm">
              ...
              {current.drug_name} {formatDose(current.dose_mg, current.dose_unit)} logged for {patient.first_name} {patient.last_name}.
            </p>
          ) : (
            <>
